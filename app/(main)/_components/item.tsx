...
const Item = ({
    ...
    return (
        ...
        >
            ...
            {!!id && (
                <div className="ml-auto flex items-center gap-x-2" role="button">
                    <DropdownMenu>
                    ...
                    <div className="opacity-0 group-hover:opacity-100 h-full ml-auto rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600" onClick={onCreate}>
